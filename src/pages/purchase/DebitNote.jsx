...
const DebitNote = () => {
    ...
    <div className="bg-[#F5F5F5] min-h-screen flex flex-col pb-16">
      <div className="bg-white shadow-sm px-4 py-3 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <ChevronLeft 
            ...
            onClick={handleBack}
          />
          <h1 className="text-xl font-semibold text-[#1D1D1D]">Debit Notes</h1>
        </div>
      </div>
      ...
      <div className="p-4 flex-grow">
        ...
        <div className="flex space-x-2 mb-4">
          ...
          <button className="border border-[#D9D9D9] bg-white rounded px-3 py-1 text-sm">Show Open Notes</button>
        </div>
      ...
      <div className="text-xs text-gray-500 text-right mt-2 px-4">
        <p>Last updated: 2025-03-28 17:03:20</p>
  ...
  const renderCreateView = () => (
    <div className="bg-[#F5F5F5] min-h-screen flex flex-col pb-16">
      <div className="bg-white shadow-sm px-4 py-3 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <ChevronLeft 
            ...
            onClick={handleBack}
          />
          <h1 className="text-xl font-semibold text-[#1D1D1D]">Create Debit Note</h1>
        </div>
        <div className="flex items-center space-x-3">
      ...
      <div className="p-4 flex-grow">
        <div className="border border-dashed border-[#3460DC] p-3 rounded-lg mb-4">
          <button className="w-full text-[#3460DC] py-2">
            + Add Party
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <label className="text-[#666666] text-sm mb-2 block">Debit Note No.</label>
            <input 
              type="text" 
              defaultValue="1" 
          ...
          <div>
            <label className="text-[#666666] text-sm mb-2 block">Debit Note Date</label>
            <div className="relative">
              <input 
                type="text" 
                value={formatDate(debitNoteDate)}
